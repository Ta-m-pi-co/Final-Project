...
if(isset($_POST['update'])){
  ...
  $updateProduct = $conn->prepare("UPDATE `products` SET name = ?, details = ?, price = ? WHERE id =?");
  $updateProduct->execute([$name, $details, $price, $productId]);
...
<h1 class="heading">update product</h1>
  <?php
    ...
    $displayProducts = $conn->prepare("SELECT * FROM `products` WHERE id = ?");
